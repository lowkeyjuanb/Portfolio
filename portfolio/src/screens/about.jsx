...
export default function AboutSc() {
  return (
    <section className="w-full h-fit flex flex-col pt-32 px-20 bg-gradient-to-b from-black via-blue-950 to-black">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-2 items-center justify-between">
            <div className="flex flex-col items-left text-center lg:text-left max-w-5xl lg:pb-0 pb-10">
